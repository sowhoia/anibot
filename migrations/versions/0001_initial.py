...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("alt_titles", sa.dialects.postgresql.JSONB(), default=list),
        sa.Column("year", sa.Integer()),
        sa.Column("poster_url", sa.String()),
        sa.Column("description", sa.String()),
        sa.Column("genres", sa.dialects.postgresql.JSONB(), default=list),
        ...
        sa.Column("external_ids", sa.dialects.postgresql.JSONB(), default=dict),
